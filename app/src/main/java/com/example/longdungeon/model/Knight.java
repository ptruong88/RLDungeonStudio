package com.example.longdungeon.model;
...
public class Knight {
	...
	public Knight(Bitmap bitmap, int x, int y, int width, int height, int fps,
			int frameCount) {
		this.bitmap = bitmap;
		this.x = x;
		this.y = y;
	...
	public void draw(Canvas canvas) {
		...
		Rect destRect = new Rect(getX(), getY(), getX() + spriteWidth, getY()
				+ spriteHeight);
		// Rect destRect = new Rect(getX(), getY(), getX() + 10, getY() + 10);
